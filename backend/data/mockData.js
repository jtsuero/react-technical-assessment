...
const generateCategories = () => {
	return [
		...
		},
		{
			...
			image: "https://picsum.photos/300/200?random=cat7",
			parentId: "cat-1",
			createdAt: new Date("2024-01-01").toISOString(),
		},
	];
	...
	return [
		{
			...
			slug: "iphone-15-pro",
			description:
				"Latest iPhone with advanced features and powerful A17 Pro chip",
			price: 999.99,
			compareAtPrice: 1099.99,
			categoryId: "cat-6",
			sellerId: "user-2",
			images: [
				"https://picsum.photos/800/600?random=prod1-1",
				"https://picsum.photos/800/600?random=prod1-2",
			],
			stock: 50,
			sku: "IPH15PRO-001",
			status: "active",
		...
		},
		{
			...
			sellerId: "user-2",
			images: [
				"https://picsum.photos/800/600?random=prod2-1",
				"https://picsum.photos/800/600?random=prod2-2",
			],
			stock: 25,
			sku: "MBP16-001",
			status: "active",
		...
		},
		{
			...
			categoryId: "cat-2",
			sellerId: "user-3",
			images: ["https://picsum.photos/800/600?random=prod3"],
			stock: 100,
			sku: "NIKE-AM90-001",
			status: "active",
			featured: false,
		...
		},
		{
			...
			sellerId: "user-3",
			images: [
				"https://picsum.photos/800/600?random=prod4-1",
				"https://picsum.photos/800/600?random=prod4-2",
			],
			stock: 40,
			sku: "SGS24U-001",
			status: "active",
		...
		},
		{
			...
			categoryId: "cat-4",
			sellerId: "user-2",
			images: ["https://picsum.photos/800/600?random=prod5"],
			stock: 200,
			sku: "BOOK-GG-001",
			status: "active",
			featured: false,
		...
		},
		{
			...
			categoryId: "cat-5",
			sellerId: "user-3",
			images: ["https://picsum.photos/800/600?random=prod6"],
			stock: 75,
			sku: "YOGA-MAT-001",
			status: "active",
			featured: false,
		...
		},
		{
			...
			sellerId: "user-2",
			images: [
				"https://picsum.photos/800/600?random=prod7-1",
				"https://picsum.photos/800/600?random=prod7-2",
			],
			stock: 30,
			sku: "COFFEE-001",
			status: "active",
		...
		},
		{
			...
			sellerId: "user-3",
			images: [
				"https://picsum.photos/800/600?random=prod8-1",
				"https://picsum.photos/800/600?random=prod8-2",
			],
			stock: 60,
			sku: "HEADPHONES-001",
			status: "active",
	...
	return [
		{
			...
			title: "Amazing phone!",
			comment:
				"The iPhone 15 Pro exceeded my expectations. The camera quality is outstanding and the performance is smooth.",
		...
		},
		{
			...
			comment:
				"Love the phone but the price is quite high. Still worth it for the features.",
		...
		},
		{
			...
			comment:
				"The MacBook Pro handles all my professional tasks effortlessly. Battery life is excellent.",
			verifiedPurchase: true,
